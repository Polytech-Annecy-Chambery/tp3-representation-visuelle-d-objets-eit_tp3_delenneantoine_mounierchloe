...
def Q2b():
    ...
    return Configuration().add(
            ...
            ) #crée une section en lui donant sa position, une longueur , une largeur, on l'ajoute ensuite à la configuration
...
def Q4a():
    ...
    wall1 = Wall({'position': [0, 0, 0], 'width':7, 'height':2, 'edges':True})
    wall2 = Wall({'position': [0, 5, 0], 'width':7, 'height':2, 'edges':True})
    wall3 = Wall({'position': [0, 0, 0], 'width':5, 'height':2, 'edges':True, 'orientation':90})
    wall4 = Wall({'position': [0, -7, 0], 'width':5, 'height':2, 'edges':True, 'orientation':90})  
